...
namespace photon
{
	...
	Matrix Matrix::Perspective(float fov, float aspectRatio, float nearPlane, float farPlane)
	{
		...
		r[0] = { xScale,0,0,0 };
		r[1] = { 0,yScale,0,0};
		r[2] = { 0,0, farPlane / (nearPlane - farPlane), -1 };
		r[3] = { 0,0, (nearPlane * farPlane) / (nearPlane - farPlane),1 };
